...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $productrow = mysqli_fetch_assoc(mysqli_query($conn, $productQuery));
    ...
    VALUES ('$lastOrderMasterId', '$product_id', '$quantity', '$totalPrice')";
    if (!mysqli_query($conn, $insertOrderQuery)) {
        die("Error inserting order: " . mysqli_error($conn));
    }

    $stk_sql = "UPDATE product SET stock = stock - '$quantity' WHERE product_id = '$product_id'";
                        ...
                        <div class="col-lg-6 col-md-6">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                            <tr>
                                                <td> <strong><?php echo $product['product_name']; ?> × <?php echo $quantity; ?></strong></td>
                                                <td><strong> <?php echo '₹ ' . number_format(($product['price'] * $quantity), 2); ?></strong></td>
                            ...
                            <div class="payment_method">
                                ...
                                <div class="order_button pt-3">
                                    ...
                                    <button class="btn btn-md btn-black-default-hover" type="submit" name="submit" value="SUBMIT">Pay & Proceed</button>
                                </div>
                            </div>
                        </div>
                    </div>
