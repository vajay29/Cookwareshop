...
<body>
    <!-- Order History Display Start -->
    <h4 class="page-title" style="margin-bottom: 50px;">Order History</h4>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT o.*,c.*,d.* FROM ordermaster o JOIN customer c ON o.customer_id=c.customer_id 
                                JOIN delivery_address d ON d.deliveryaddress_id=o.deliveryaddress_id WHERE status IN ('delivered','cancelled')";;
